(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/src_2cc7edfc._.js", {

"[project]/src/lib/gameUtils.ts [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
"[project]/src/context/game-initial-state.ts [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
;
;
const pointsPerStat = Math.floor(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TOTAL_STAT_POINTS"] / 3);
const remainderPoints = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TOTAL_STAT_POINTS"] % 3;
...
const initialCharacterState = {
    ...
    maxHealth: (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$gameUtils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["calculateMaxHealth"])(initialCharacterStats),
    currentHealth: (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$gameUtils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["calculateMaxHealth"])(initialCharacterStats),
    maxStamina: (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$gameUtils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["calculateMaxActionStamina"])(initialCharacterStats),
    currentStamina: (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$gameUtils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["calculateMaxActionStamina"])(initialCharacterStats),
    maxMana: (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$gameUtils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["calculateMaxMana"])(initialCharacterStats, []),
    currentMana: (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$gameUtils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["calculateMaxMana"])(initialCharacterStats, []),
    level: 1,
    xp: 0,
    ...
    skillTree: null,
    skillTreeStage: 0,
    learnedSkills: (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$gameUtils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getStarterSkillsForClass"])("Adventurer")
};
...
"[project]/src/context/reducers/characterReducer.ts [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
    ...
    switch(action.type){
        case "CREATE_CHARACTER":
            {
                ...
                const maxHealth = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$gameUtils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["calculateMaxHealth"])(baseStats);
                const maxActionStamina = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$gameUtils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["calculateMaxActionStamina"])(baseStats);
                const maxMana = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$gameUtils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["calculateMaxMana"])(baseStats, baseKnowledge);
                const characterClass = action.payload.class ?? __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$context$2f$game$2d$initial$2d$state$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["initialCharacterState"].class;
                const starterSkills = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$gameUtils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getStarterSkillsForClass"])(characterClass);
                const initialLevel = 1;
                const initialXpToNext = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$gameUtils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["calculateXpToNextLevel"])(initialLevel);
                const newCharacter = {
        ...
        case "UPDATE_CHARACTER":
            {
                ...
                const newMaxHealth = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$gameUtils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["calculateMaxHealth"])(updatedStats);
                const newMaxActionStamina = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$gameUtils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["calculateMaxActionStamina"])(updatedStats);
                const newMaxMana = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$gameUtils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["calculateMaxMana"])(updatedStats, updatedKnowledge);
                return {
                    ...state,
                    ...action.payload,
                    stats: updatedStats,
        ...
        case "LEVEL_UP":
            {
                ...
                const newMaxHealth = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$gameUtils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["calculateMaxHealth"])(state.stats);
                const newMaxActionStamina = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$gameUtils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["calculateMaxActionStamina"])(state.stats);
                const newMaxMana = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$gameUtils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["calculateMaxMana"])(state.stats, state.knowledge);
                return {
                    ...state,
        ...
        case "CHANGE_CLASS_AND_RESET_SKILLS":
            {
                ...
                const starterSkills = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$gameUtils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getStarterSkillsForClass"])(action.payload.newClass);
                return {
                    ...state,
        ...
        case "UPDATE_NARRATION":
            {
                ...
                if (updatedStats || updatedKnowledge) {
                    newState.maxHealth = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$gameUtils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["calculateMaxHealth"])(newState.stats);
                    newState.maxStamina = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$gameUtils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["calculateMaxActionStamina"])(newState.stats);
                    newState.maxMana = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$gameUtils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["calculateMaxMana"])(newState.stats, newState.knowledge);
                }
        ...
        case "LOAD_ADVENTURE":
            ...
            return {
                ...
                maxHealth: typeof savedChar?.maxHealth === 'number' ? savedChar.maxHealth : (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$gameUtils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["calculateMaxHealth"])(validatedStats),
                currentHealth: typeof savedChar?.currentHealth === 'number' ? savedChar.currentHealth : savedChar?.maxHealth ?? (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$gameUtils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["calculateMaxHealth"])(validatedStats),
                maxStamina: typeof savedChar?.maxStamina === 'number' ? savedChar.maxStamina : (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$gameUtils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["calculateMaxActionStamina"])(validatedStats),
                currentStamina: typeof savedChar?.currentStamina === 'number' ? savedChar.currentStamina : savedChar?.maxStamina ?? (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$gameUtils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["calculateMaxActionStamina"])(validatedStats),
                maxMana: typeof savedChar?.maxMana === 'number' ? savedChar.maxMana : (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$gameUtils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["calculateMaxMana"])(validatedStats, validatedKnowledge),
                currentMana: typeof savedChar?.currentMana === 'number' ? savedChar.currentMana : savedChar?.maxMana ?? (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$gameUtils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["calculateMaxMana"])(validatedStats, validatedKnowledge),
                level: typeof savedChar?.level === 'number' ? savedChar.level : 1,
                xpToNextLevel: typeof savedChar?.xpToNextLevel === 'number' ? savedChar.xpToNextLevel : (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$gameUtils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["calculateXpToNextLevel"])(savedChar?.level ?? 1),
                ...
                learnedSkills: Array.isArray(savedChar?.learnedSkills) && savedChar.learnedSkills.length > 0 ? savedChar.learnedSkills.map((skill)=>({
                        ...
                        manaCost: typeof skill.manaCost === 'number' ? skill.manaCost : undefined,
                        staminaCost: typeof skill.staminaCost === 'number' ? skill.staminaCost : undefined
                    })) : (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$gameUtils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getStarterSkillsForClass"])(loadedCharClass)
            };
        default:
            return state;
    }
...
"[project]/src/context/reducers/inventoryReducer.ts [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
function inventoryReducer(state, action) {
    switch(action.type){
        ...
        case "START_GAMEPLAY":
            ...
            return [
                ...__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$context$2f$game$2d$initial$2d$state$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["initialInventory"]
            ]; // Return a copy
        case "RESET_GAME":
...
"[project]/src/context/reducers/settingsReducer.ts [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
        ...
        case "SET_ADVENTURE_SETTINGS":
            {
                ...
                const validatedDifficulty = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["VALID_ADVENTURE_DIFFICULTY_LEVELS"].includes(incomingPayload.difficulty) ? incomingPayload.difficulty : state.adventureSettings.difficulty;
        ...
        case "SET_ADVENTURE_TYPE":
            {
                ...
                const preservedDifficulty = state.adventureSettings.difficulty || __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$context$2f$game$2d$initial$2d$state$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["initialAdventureSettings"].difficulty;
                const preservedPermadeath = state.adventureSettings.permanentDeath !== undefined ? state.adventureSettings.permanentDeath : __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$context$2f$game$2d$initial$2d$state$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["initialAdventureSettings"].permanentDeath;
                return {
                    ...state,
                    adventureSettings: {
                        // Start with a clean slate for adventure-specific settings
                        ...__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$context$2f$game$2d$initial$2d$state$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["initialAdventureSettings"],
...
"[project]/src/lib/game-state-utils.ts [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
"[project]/src/context/reducers/adventureReducer.ts [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
        ...
        case "START_GAMEPLAY":
            {
                if (state.adventureSettings.adventureType !== "Coop" && !state.character) {
                    ...
                    return {
                        ...__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$context$2f$game$2d$initial$2d$state$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["initialState"],
                ...
                const adventureId = state.currentAdventureId || (state.adventureSettings.adventureType === "Coop" ? state.sessionId : (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$gameUtils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["generateAdventureId"])());
                const turnCount = state.turnCount > 0 ? state.turnCount : 0;
                const currentInventory = state.inventory.length > 0 ? state.inventory : [
                    ...__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$context$2f$game$2d$initial$2d$state$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["initialInventory"]
                ];
                const initialGameState = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$game$2d$state$2d$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["updateGameStateString"])(state.storyLog.length > 0 ? state.currentGameStateString : "The adventure is about to begin...", state.character, currentInventory, turnCount);
        ...
        case "UPDATE_NARRATION":
            {
                ...
                if (updatedCharacter) {
                    ...
                    if (updatedStats) {
                        ...
                        updatedCharacter.maxHealth = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$gameUtils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["calculateMaxHealth"])(updatedCharacter.stats);
                        updatedCharacter.maxStamina = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$gameUtils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["calculateMaxActionStamina"])(updatedCharacter.stats);
                        updatedCharacter.maxMana = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$gameUtils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["calculateMaxMana"])(updatedCharacter.stats, updatedCharacter.knowledge);
                    }
                    // Update Lists
                ...
                const updatedGameState = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$game$2d$state$2d$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["updateGameStateString"])(action.payload.updatedGameState, updatedCharacter, state.inventory, newTurnCount);
        ...
        case "RESPAWN_CHARACTER":
            {
                ...
                const respawnLogEntry = {
                    ...
                    updatedGameState: (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$game$2d$state$2d$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["updateGameStateString"])(state.currentGameStateString, state.character, state.inventory, state.turnCount),
                    timestamp: Date.now()
                };
        ...
        case "UPDATE_CRAFTING_RESULT":
            {
                ...
                const finalGameStateString = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$game$2d$state$2d$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["updateGameStateString"])(providedGameState || state.currentGameStateString, state.character, state.inventory, newTurnCount);
        ...
        case "END_ADVENTURE":
            {
                ...
                if (action.payload.finalNarration && (!state.currentNarration || action.payload.finalNarration.narration !== state.currentNarration.narration)) {
                    ...
                    if (finalCharacterState) {
                        finalGameState = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$game$2d$state$2d$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["updateGameStateString"])(action.payload.finalNarration.updatedGameState, finalCharacterState, finalInventoryState, finalTurnCount);
                    }
                }
                ...
                if (finalCharacterState && state.currentAdventureId && state.adventureSettings.adventureType !== "Coop") {
                    ...
                    localStorage.setItem(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["SAVED_ADVENTURES_KEY"], JSON.stringify(updatedSavedAdventures));
                }
                return {
                    ...state,
        ...
        case "SAVE_CURRENT_ADVENTURE":
            {
                ...
                const currentSave = {
                    ...
                    currentGameStateString: (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$game$2d$state$2d$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["updateGameStateString"])(state.currentGameStateString, state.character, state.inventory, state.turnCount),
                ...
                localStorage.setItem(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["SAVED_ADVENTURES_KEY"], JSON.stringify(newSaves));
                return {
                    ...state,
        ...
        case "DELETE_ADVENTURE":
            {
                ...
                localStorage.setItem(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["SAVED_ADVENTURES_KEY"], JSON.stringify(filteredSaves));
                return {
                    ...state,
...
"[project]/src/context/game-reducer.ts [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$context$2f$game$2d$initial$2d$state$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/context/game-initial-state.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$context$2f$reducers$2f$characterReducer$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/context/reducers/characterReducer.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$context$2f$reducers$2f$inventoryReducer$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/context/reducers/inventoryReducer.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$context$2f$reducers$2f$settingsReducer$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/context/reducers/settingsReducer.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$context$2f$reducers$2f$adventureReducer$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/context/reducers/adventureReducer.ts [app-client] (ecmascript)"); // This will handle most game flow logic
"use client";
;
;
;
...
function gameReducer(state, action) {
    ...
    const updatedCharacter = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$context$2f$reducers$2f$characterReducer$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["characterReducer"])(state.character, action);
    const updatedInventory = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$context$2f$reducers$2f$inventoryReducer$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["inventoryReducer"])(state.inventory, action);
    const settingsRelatedState = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$context$2f$reducers$2f$settingsReducer$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["settingsReducer"])({
        adventureSettings: state.adventureSettings,
        selectedThemeId: state.selectedThemeId,
        isDarkMode: state.isDarkMode,
        userGoogleAiApiKey: state.userGoogleAiApiKey
    ...
    nextState = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$context$2f$reducers$2f$adventureReducer$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["adventureReducer"])(nextState, action);
    switch(action.type){
        case "RESET_GAME":
            {
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$context$2f$game$2d$initial$2d$state$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/context/game-initial-state.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$context$2f$game$2d$reducer$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/context/game-reducer.ts [app-client] (ecmascript)");
...
const GameProvider = ({ children })=>{
    ...
    const applyTheme = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "GameProvider.useCallback[applyTheme]": (themeId, isDark)=>{
            const theme = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$themes$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["THEMES"].find({
                "GameProvider.useCallback[applyTheme]": (t)=>t.id === themeId
            }["GameProvider.useCallback[applyTheme]"]) || __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$themes$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["THEMES"][0];
            const colors = isDark ? theme.dark : theme.light;
            const root = document.documentElement;
            if (!root) return;
            Object.entries(colors).forEach({
                "GameProvider.useCallback[applyTheme]": ([property, value])=>{
                    root.style.setProperty(property, value);
                }
            }["GameProvider.useCallback[applyTheme]"]);
            if (isDark) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "GameProvider.useEffect": ()=>{
            ...
            try {
                const savedData = localStorage.getItem(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["SAVED_ADVENTURES_KEY"]);
                if (savedData) {
                    ...
                    if (Array.isArray(loadedAdventures)) {
                        ...
                        localStorage.removeItem(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["SAVED_ADVENTURES_KEY"]);
                    }
                }
            } catch (error) {
            ...
            const savedThemeId = localStorage.getItem(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["THEME_ID_KEY"]) || __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$context$2f$game$2d$initial$2d$state$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["initialState"].selectedThemeId;
            const savedMode = localStorage.getItem(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["THEME_MODE_KEY"]);
            const prefersDark = window.matchMedia('(prefers-color-scheme: dark)').matches;
            const initialDarkMode = savedMode === 'dark' || savedMode === null && prefersDark;
            const savedUserApiKey = localStorage.getItem(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["USER_API_KEY_KEY"]);
            if (savedUserApiKey) {
                dispatch({
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "GameProvider.useEffect": ()=>{
            ...
            localStorage.setItem(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["THEME_ID_KEY"], state.selectedThemeId);
            localStorage.setItem(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["THEME_MODE_KEY"], state.isDarkMode ? 'dark' : 'light');
        }
    }["GameProvider.useEffect"], [
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "GameProvider.useEffect": ()=>{
            ...
            if (state.userGoogleAiApiKey) {
                localStorage.setItem(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["USER_API_KEY_KEY"], state.userGoogleAiApiKey);
            } else {
                // Only remove if explicitly null (cleared), undefined might be initial load
                if (state.userGoogleAiApiKey === null) {
                    localStorage.removeItem(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["USER_API_KEY_KEY"]);
                }
            }
        }
    }["GameProvider.useEffect"], [
    ...
    */ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "GameProvider.useEffect": ()=>{
            ...
            const reputationString = state.character ? Object.entries(state.character.reputation).map({
                "GameProvider.useEffect": ([f, s])=>`${f}: ${s}`
            }["GameProvider.useEffect"]).join(', ') || 'None' : 'N/A';
            const relationshipString = state.character ? Object.entries(state.character.npcRelationships).map({
                "GameProvider.useEffect": ([n, s])=>`${n}: ${s}`
            }["GameProvider.useEffect"]).join(', ') || 'None' : 'N/A';
            const inventoryString = state.inventory.map({
                "GameProvider.useEffect": (i)=>`${i.name}${i.quality ? ` (${i.quality})` : ''}`
            }["GameProvider.useEffect"]).join(', ') || 'Empty';
...
_s(GameProvider, "Y+Yu+bkjp5HUdC0kmYHjiKkE0B8=");
_c = GameProvider;
const useGame = ()=>{
    _s1();
...
const ToastViewport = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["forwardRef"])(_c = ({ className, ...props }, ref)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$radix$2d$ui$2f$react$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Viewport"], {
        ref: ref,
        className: (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["cn"])(// Changed default positioning to bottom-0 for mobile
...
const toastVariants = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$class$2d$variance$2d$authority$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["cva"])("group pointer-events-auto relative flex w-full items-center justify-between space-x-4 overflow-hidden rounded-md border p-6 pr-8 shadow-lg transition-all data-[swipe=cancel]:translate-x-0 data-[swipe=end]:translate-x-[var(--radix-toast-swipe-end-x)] data-[swipe=move]:translate-x-[var(--radix-toast-swipe-move-x)] data-[swipe=move]:transition-none data-[state=open]:animate-in data-[state=closed]:animate-out data-[swipe=end]:animate-out data-[state=closed]:fade-out-80 data-[state=closed]:slide-out-to-right-full data-[state=open]:slide-in-from-bottom-full data-[state=open]:sm:slide-in-from-bottom-full", {
    variants: {
        variant: {
...
function Toaster() {
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$toast$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ToastProvider"], {
        children: [
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$toast$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ToastViewport"], {
...
//# sourceMappingURL=src_2cc7edfc._.js.map