...
import * as DialogPrimitive from "@radix-ui/react-dialog" // Use DialogPrimitive directly
...
>(({ className, ...props }, ref) => (
  <DialogPrimitive.Overlay
    className={cn(
      "fixed inset-0 z-50 bg-black/30 data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 backdrop-blur-sm", // Adjusted opacity and added backdrop blur
      className
    )}
    {...props}
    ref={ref}
...
SheetContent.displayName = DialogPrimitive.Content.displayName // Use DialogPrimitive.Content.displayName
...
SheetTitle.displayName = DialogPrimitive.Title.displayName // Use DialogPrimitive.Title.displayName
...
SheetDescription.displayName = DialogPrimitive.Description.displayName // Use DialogPrimitive.Description.displayName
