...
import { CardContent } from "@/components/game/CardboardCard"; // Only need CardContent maybe
import { ScrollArea } from "@/components/ui/scroll-area";
import { Backpack, PackageSearch, Package, Info } from "lucide-react"; // Added Package, Info
import {
  Tooltip,
  TooltipContent,
  TooltipProvider,
