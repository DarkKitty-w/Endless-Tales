...
const NarrateAdventureInputSchema = z.object({
  character: z.object({
    ...
    class: z.string().describe('The character\'s class (e.g., Warrior, Mage). For Immersed mode, this might be an archetype or role from the universe.'),
    ...
    skillTreeSummary: z
      ...
      .nullable()
      .describe('A summary of the character\'s skill tree and available skills. Not applicable for Immersed mode.'),
    skillTreeStage: z.number().describe('The character\'s current skill tree stage. Not applicable for Immersed mode.'),
...
const NarrateAdventureOutputSchema = z.object({
  ...
  progressedToStage: z.number().optional().describe("Optional: The new skill stage (0-4) if the character progressed (not applicable for Immersed mode)."),
...
*   **INSTRUCTION (Immersed):** The narrative MUST strongly adhere to the lore, characters, and tone of the specified 'Universe'. The player's 'Character Concept' is paramount. Avoid class-based skill trees, XP, and standard leveling for Immersed mode; character development, new abilities, or status changes should be purely narrative-driven and logical within the universe.
