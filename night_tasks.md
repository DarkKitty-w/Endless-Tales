# Travail de nuit – Toutes les tâches détaillées

Tu es un développeur senior. Exécute chaque point de la liste ci-dessous, dans l’ordre. Ne saute aucune ligne, ne simplifie rien. Quand tu as tout fait, arrête-toi.
